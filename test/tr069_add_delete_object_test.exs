defmodule Caretaker.TR069.RPC.AddDeleteObjectTest do
  ...
  test "encode add and delete object" do
    assert {:ok, add} = AddObject.encode(AddObject.new("Device.WiFi.SSID.1.", parameter_key: "k2"))
    ...
    assert {:ok, del} = DeleteObject.encode(DeleteObject.new("Device.WiFi.SSID.1.", parameter_key: "k3"))
