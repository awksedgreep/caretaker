defmodule Caretaker.TR069.RPC.GetQueuedTransfers do
  @moduledoc """
  TR-069 GetQueuedTransfers (ACS -> CPE), empty body.
  """
  ...
  def encode(%__MODULE__{}), do: Lather.Xml.Builder.build_fragment(%{"cwmp:GetQueuedTransfers" => %{}})
