defmodule Caretaker.TR069.RPC.CancelTransferResponse do
  @moduledoc """
  TR-069 CancelTransferResponse (CPE -> ACS), empty body.
  """
  ...
  def encode(%__MODULE__{}), do: Lather.Xml.Builder.build_fragment(%{"cwmp:CancelTransferResponse" => %{}})
